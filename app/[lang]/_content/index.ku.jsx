    ...
    <>
      ...
      <section id="home" className="relative isolate flex min-h-screen items-center overflow-hidden">
        ...
        <div className="wrap w-full pt-[170px] pb-[130px]">
          ...
          <div className="m-register flex flex-wrap gap-4" style={{ '--m-delay': '470ms', '--m-dur': '620ms' }}>
            <Button asChild>
              <Link href="/ku/projects.html">پرۆژەکانمان ببینە <ArrowRightIcon /></Link>
            </Button>
            <Button asChild variant="heroOutline">
              <Link href="/ku/contact.html">پەیوەندیمان پێوە بکە <ArrowRightIcon /></Link>
            </Button>
          </div>
          ...
          <div>
            ...
            <div className="mt-8">
              <Button asChild variant="outline">
                <Link href="/ku/about.html">زیاتر دەربارەمان <ArrowRightIcon /></Link>
              </Button>
            </div>
          </div>
      ...
      <section className="py-17 md:py-26" id="services">
        ...
        <div className="wrap mt-11 text-center">
          <Button asChild>
            <Link href="/ku/services.html">هەموو خزمەتگوزارییەکان ببینە <ArrowRightIcon /></Link>
          </Button>
        </div>
      </section>
            ...
            <div className="flex flex-col justify-center bg-brand-darker p-12 text-white">
              ...
              <div className="mt-7">
                <Button asChild variant="white">
                  <Link href="/ku/projects.html">هەموو پرۆژەکان ببینە <ArrowRightIcon /></Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      >
        <Reveal as="div" className="wrap max-w-[780px]">
          ...
          <div className="mt-6">
            <Button asChild variant="heroOutline">
              <Link href="/ku/about.html#csr">زیاتر بزانە <ArrowRightIcon /></Link>
            </Button>
          </div>
        </Reveal>
      </section>
      ...
      <section className="bg-brand py-13 text-center text-white md:py-19">
        <div className="wrap">
          ...
          <Button asChild variant="dark">
            <Link href="/ku/contact.html">پەیوەندی بە تیمەکەمانەوە بکە</Link>
          </Button>
        </div>
      </section>
    </>
